...
export function AisheetLandingPage() {
  ...
  return (
      ...
      <main className="flex-1">
            ...
            <div className="grid gap-8 sm:grid-cols-2">
              <div className="flex flex-col p-8 bg-white rounded-xl shadow-lg border border-red-100">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  &ldquo;As a data analyst, Aisheet has been a game-changer. The ability to use AI directly in my spreadsheets has sped up my workflow tremendously. It&apos;s still in beta, but I&apos;m already seeing great potential!&rdquo;
                </p>
        ...
        <section className="w-full py-20 md:py-32 lg:py-40 bg-red-600 text-white">
          <div className="container px-6 md:px-8 max-w-6xl mx-auto">
            <div className="flex flex-col items-center space-y-8 text-center">
              <div className="space-y-4">
                ...
                <p className="mx-auto max-w-2xl text-xl leading-relaxed">
                  Get started with Aisheet today and experience the power of AI in your Google Sheets.
                </p>
              </div>
              <div className="w-full max-w-md space-y-4">
                <form className="flex space-x-4">
                  <Input className="flex-1 bg-white text-black text-lg py-3" placeholder="Enter your email" type="email" />
                  <Button type="submit" className="bg-white text-red-600 hover:bg-red-100 text-lg px-8 py-3">Get Started</Button>
                </form>
              </div>
            </div>
          </div>
