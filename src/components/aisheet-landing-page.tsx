...
The ability to use AI directly in my spreadsheets has sped up my workflow tremendously. It&apos;s still in beta, but I&apos;m already seeing great potential!&rdquo;
              </p>
            ...
            <div className="flex flex-col p-8 bg-white rounded-xl shadow-lg border border-red-100">
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                &ldquo;I&apos;ve been testing Aisheet for my content planning, and it&apos;s been incredibly helpful. The multiple AI model support is fantastic. There are a few bugs here and there, but the team is very responsive.&rdquo;
              </p>
            ...
            <div className="flex flex-col p-8 bg-white rounded-xl shadow-lg border border-red-100">
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                &ldquo;The token calculation feature in Aisheet is brilliant! It helps me keep track of my AI usage costs. The UI could use some polishing, but overall, it&apos;s a promising tool for my research work.&rdquo;
              </p>
            ...
            <div className="flex flex-col p-8 bg-white rounded-xl shadow-lg border border-red-100">
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                &ldquo;As an early adopter, I&apos;m impressed with Aisheet&apos;s potential. The simple formulas make it easy to integrate AI into my financial models. Looking forward to seeing how it evolves!&rdquo;
              </p>
      ...
      <section id="faq" className="w-full py-20 md:py-32 lg:py-40 bg-red-50">
        <div className="container px-6 md:px-8 max-w-6xl mx-auto">
          ...
          <div className="mx-auto max-w-3xl space-y-8">
            {[
              {
                q: "How do I get started with Aisheet?",
                a: "Simply install our Google Sheets <sup>TM</sup> add-on and start using AI formulas in your spreadsheets."
              },
              {
                q: "Which AI models are supported?",
                a: "We currently support ChatGPT, Claude, Groq, and Gemini <sup>TM</sup>."
              },
              {
        ...
        <div className="container px-6 md:px-8 max-w-6xl mx-auto">
          <div className="flex flex-col items-center space-y-8 text-center">
            <div className="space-y-4">
              ...
              Join our waitlist to be notified when Aisheet is available in the Google Sheets <sup className="text-xs">TM</sup> Marketplace.
              </p>
            </div>
        ...
        <DialogContent className="bg-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-lg text-gray-600">
              Our Google Sheets add-on is currently under review for the Google Sheets <sup className="text-xs">TM</sup> Marketplace. We&apos;ll notify you as soon as it&apos;s available. Thank you for your interest!
            </DialogDescription>
          </DialogHeader>
