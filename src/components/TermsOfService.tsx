  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center p-4 text-gray-800">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-4xl">
        ...
        <p className="mb-4">
          To provide and enhance our services, we collect and store user data, including but not limited to name, email address, and payment information. Our commitment to your privacy is paramount, and our handling of user data is transparently outlined in our Privacy Policy at https://aisheet.vercel.app/PrivacyPolicy.
        </p>
        ...
        <p className="mb-4">
          We reserve the right to modify or replace these Terms at any time. We will notify users of any changes by posting the new Terms on this page and updating the &quot;Last Updated&quot; date. Continued use of our Website and services after any such changes constitutes your acceptance of the new Terms.
        </p>
        <p className="mb-4">
