  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center p-4 text-gray-800">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-4xl">
        ...
        <h3 className="text-xl font-bold mb-2">1.1 Personal Data</h3>
        <p className="mb-4">
          We gather the following personal information from you:
        </p>
        ...
        <h3 className="text-xl font-bold mb-2">1.2 Non-Personal Data</h3>
        <p className="mb-4">
          We may utilize web cookies and similar technologies to gather non-personal data such as your IP address, browser type, device specifics, and browsing behavior. This information aids us in improving your browsing experience on our Website, understanding user trends, and enhancing our services.
        </p>
        <h2 className="text-2xl font-bold mb-4">2. Purpose of Data Collection</h2>
        <p className="mb-4">
          Your personal data is collected and utilized solely for processing your web scraping tasks. This encompasses managing your requests, confirming your actions, offering customer support, and keeping you informed about the status of your requests and our services.
        </p>
        <h2 className="text-2xl font-bold mb-4">3. Data Sharing</h2>
        <p className="mb-4">
          Your personal data is not shared with third parties, except as necessary for completing your web scraping requests (e.g., integrating with third-party APIs or payment processors for service enhancement). We strictly prohibit the selling, trading, or renting of your personal information to others.
        </p>
        ...
        <p className="mb-4">
          This Privacy Policy may be updated periodically to reflect changes in our data practices or for other operational, legal, or regulatory reasons. Any modifications will be posted on this page, and we may also inform you of significant changes via email.
        </p>
        <h2 className="text-2xl font-bold mb-4">6. Contact Information</h2>
        <p className="mb-4">
          For any questions, concerns, or requests relating to this Privacy Policy, please reach out to us at:
        </p>
        <p className="mb-4">
          Email: tuanvutruong@gmail.com
        </p>
        <p className="mb-4">
